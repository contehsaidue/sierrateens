...
<td>
  <a href="controller.php?deleteindexsettings=<?php echo $row['indexid'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this homepage settings?')";
    title="Delete">  <i class="bi bi-trash"></i></a>
    <a href="homepage-header-edit?editindexsettings=<?php echo $row['indexid'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm" onclick="return confirm('Do you want to edit this homepage settings?')";
	...
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title text-uppercase"><img src="../assets/images/logo.jpg" style="width: 65px; height: 55px;" class="me-2"><strong> Homepage Header</strong></h5>
		</div>
