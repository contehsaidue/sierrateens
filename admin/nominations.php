...
<!-- Dashboard sidebar ends -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Teen's Choice Award Nominations Entry</h1>
      <nav>
        <ol class="breadcrumb">
...
include '../includes/config.php';
 $query = "SELECT * FROM tblnominations ORDER BY id DESC";
 ...
 if ($rowcount > 0){
    ...
    <td><?php echo $row['attesttation'];?></td> 
<td>
  <a href="controller.php?deletevisitornomination=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this nominee?')";
