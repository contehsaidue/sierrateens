...
error_reporting(0);
if(isset($_GET['editshopsettings'])){
    $updateid = $_GET['editshopsettings'];
 $query = "SELECT * FROM tblshopsettings WHERE id = '$updateid'";
...
<img class="img-fluid rounded bgimage-size" src="../<?php echo $row['bgimage'];?>" />  
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdateshopsettings">Update Settings</button>
</form>
  </main><!-- End #main -->
