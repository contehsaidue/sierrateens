...
<!-- Dashboard sidebar ends -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Sierrateens Shop Order Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
...
include '../includes/config.php';
 $query = "SELECT * FROM tblshop JOIN tblshoporder ON tblshoporder.nameofproduct = tblshop.productid ORDER BY tblshop.productid DESC";
...
<td>
  <a href="controller.php?deleteorder=<?php echo $row['orderid'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this product order?')";
