...
include '../includes/config.php';
 $query = "SELECT * FROM tblaboutsettings";
...
<td>
  <a href="controller.php?deleteaboutsettings=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this about page settings?')";
    title="Delete">  <i class="bi bi-trash"></i></a>
    <a href="aboutsettings-edit?editaboutsettings=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm" onclick="return confirm('Do you want to edit this about page settings?')";
	...
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title text-uppercase"><img src="../assets/images/logo.jpg" style="width: 65px; height: 55px;" class="me-2"><strong> About Settings </strong> <i class="bi bi-tools"></i></h5>
		</div>
		...
		<div class="modal-footer">
			<button type="submit" class="btn btn-success fw-bold" name="adminaboutsettings">Save Details</button>
