...
if(isset($_GET['editeventsettings'])){
    $updateid = $_GET['editeventsettings'];
 $query = "SELECT * FROM tbleventsettings WHERE id = '$updateid'";
...
<img class="img-fluid rounded bgimage-size" src="../<?php echo $row['bgimage'];?>" />  
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdateeventsettings">Update Settings</button>
</form>
  </main><!-- End #main -->
