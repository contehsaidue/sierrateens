    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <div class="btn-group me-2">
            <button  class="btn btn-sm btn-dark fw-bold"  data-bs-toggle="modal" data-bs-target="#adminGallery">Gallery <i class="bi bi-image"></i> </button>
          </div>
      </nav>
    </div><!-- End Page Title -->
   <!-- Feedback Message -->
...
<td>
  <a href="controller.php?deletegalleryimage=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this image?')";
...
<!--Admin Gallery Modal -->
<div class="modal fade" id="adminGallery">
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title text-uppercase"><img src="../assets/images/logo.jpg" style="width: 65px; height: 55px;" class="me-2"><strong> Sierrateens Gallery</strong> <i class="bi bi-image"></i></h5>
		</div>
...
<div class="col-md-6">
		...
		<div class="modal-footer">
			<button type="submit" class="btn btn-success fw-bold" name="adminimage">Add Image</button>
