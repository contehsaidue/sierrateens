...
error_reporting(0);
if(isset($_GET['editindexsettings'])){
    $updateid = $_GET['editindexsettings'];
 $query = "SELECT * FROM tblindexsettings WHERE indexid = '$updateid'";
 ...
 $row = mysqli_fetch_assoc($queryrun);
	...
	<form action="controller.php" method="POST" enctype="multipart/form-data">
        <div class="row">
        <input type="hidden" name="updateid" value="<?php echo $row['indexid'];?>">
        <div class="col-md-6">
...
<img class="img-fluid rounded bgimage-size" src="../<?php echo $row['bgimage'];?>" />  
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdatehome">Update Settings</button>
</form>
  </main><!-- End #main -->
