...
<!-- Dashboard sidebar ends -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Sierrateens Shop Edit Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
...
if(isset($_GET['editproduct'])){
    $updateid = $_GET['editproduct'];
 $query = "SELECT * FROM tblshop WHERE productid = '$updateid'";
...
<form action="controller.php" method="POST" enctype="multipart/form-data">
		<div class="modal-body">
            <div class="row">
            <input type="hidden" name="updateid" value="<?php echo $row['productid'];?>">
                <div class="col-md-6">
				<div class="form-group mb-3">
				  <input type="file" class="form-control" name="productimagenew">
				</div>
</div> <!-- col 1 ends -->
<div class="col-md-6">
				<div class="form-group mb-3">
...
<div class="col-md-6">
    <div class="form-group mb-3">
        <input type="text" class="form-control" placeholder="Product Price" name="productprice" value="<?php echo $row['productprice'];?>">
    </div>
</div> <!-- col 2 ends -->
</div>
		</div>
		<div class="modal-footer">
			<button type="submit" class="btn btn-success fw-bold" name="adminupdateproduct">Update Product</button>
		</div>
		</form>
  </main><!-- End #main -->
