...
error_reporting(0);
if(isset($_GET['editteamsettings'])){
    $updateid = $_GET['editteamsettings'];
 $query = "SELECT * FROM tblteamsettings WHERE id = '$updateid'";
...
<img class="img-fluid rounded bgimage-size" src="../<?php echo $row['bgimage'];?>" />  
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdateteamsettings">Update Settings</button>
</form>
  </main><!-- End #main -->
