...
if(isset($_GET['editabout'])){
    $updateid = $_GET['editabout'];
 $query = "SELECT * FROM tblabout WHERE id = '$updateid'";
...
<div class="col-md-12">
    ...
    <div class="form-group mb-3">
        ...
        <?php echo $row['about'];?>
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdateabout">Update About Info</button>
		</form>
