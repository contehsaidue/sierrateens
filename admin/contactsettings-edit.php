...
error_reporting(0);
if(isset($_GET['editcontactsettings'])){
    $updateid = $_GET['editcontactsettings'];
 $query = "SELECT * FROM tblcontactsettings WHERE id = '$updateid'";
...
<img class="img-fluid rounded bgimage-size" src="../<?php echo $row['bgimage'];?>" />  
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdatecontactsettings">Update Settings</button>
</form>
  </main><!-- End #main -->
