...
<td>
  <a href="controller.php?deletecontactsettings=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-danger btn-sm" onclick="return confirm('Do you want to remove this contact page settings?')";
    title="Delete">  <i class="bi bi-trash"></i></a>
    <a href="contactsettings-edit?editcontactsettings=<?php echo $row['id'];?>" class="text-white mr-2 text-decoration-none btn btn-success btn-sm" onclick="return confirm('Do you want to edit this contact page settings?')";
	...
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title text-uppercase"><img src="../assets/images/logo.jpg" style="width: 65px; height: 55px;" class="me-2"><strong> Contact Settings </strong> <i class="bi bi-tools"></i></h5>
		</div>
		...
		<div class="modal-footer">
			<button type="submit" class="btn btn-success fw-bold" name="admincontactsettings">Save Details</button>
