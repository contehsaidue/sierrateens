...
error_reporting(0);
if(isset($_GET['editgallerysettings'])){
    $updateid = $_GET['editgallerysettings'];
 $query = "SELECT * FROM tblgallerysettings WHERE id = '$updateid'";
...
<img class="img-fluid rounded bgimage-size" src="../<?php echo $row['bgimage'];?>" />  
			...
			<button type="submit" class="btn btn-success fw-bold" name="adminupdategallerysettings">Update Settings</button>
</form>
  </main><!-- End #main -->
